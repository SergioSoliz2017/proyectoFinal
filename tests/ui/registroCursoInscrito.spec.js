...
test(`Test registro de nuevo curso inscrito valido`, async ({ cursos }) => {
  try {
    ...
    await cursos.screenshot({
      path: screenshotPath(`Test verificar registro de curso inscrito valido`),
    });
    Logger.error(err);
    throw err;
  }
...
test(`Test registro de nuevo curso inscrito valido - listas`, async ({
  ...
  try {
    ...
    await listas.screenshot({
      path: screenshotPath(
        `Test verificar registro de curso inscrito valido - listas`
      ),
    });
    Logger.error(err);
    throw err;
...
test(`Test registro de pago nuevo curso inscrito valido`, async ({
  ...
  try {
    ...
    await cursos.screenshot({
      path: screenshotPath(
        `Test verificar pago registro de curso inscrito valido`
      ),
    });
    Logger.error(err);
    throw err;
...
test(`Test registro de pago nuevo curso inscrito valido - listas`, async ({
  ...
  try {
    Logger.info(
      `Test verificar pago registro de curso inscrito valido - listas`
    );
    const registro = new RegistroCursoInscritoPage(listas);
    Logger.info(`Seleccionar curso`);
    Logger.debug(`Curso: APOYO`);
  ...
  for (const {
    ...
    test(`Test verificar descuento: ${key} - ${tipo}`, async ({ cursos }) => {
      try {
        ...
        await cursos.screenshot({
          path: screenshotPath(`Test verificar descuento ${tipo}}`),
        });
        Logger.error(err);
        throw err;
      }
  ...
  for (const {
    ...
    test(`Test verificar descuento listas: ${key} - ${tipo}`, async ({
      ...
      try {
        ...
        await listas.screenshot({
          path: screenshotPath(
            `Test verificar descuento listas: ${key} - ${tipo}`
          ),
        });
        Logger.error(err);
        throw err;
...
test(`Test verificar cambio icono descuento`, async ({ cursos }) => {
  try {
    ...
    await cursos.screenshot({
      path: screenshotPath(`Test verificar cambio icono descuento`),
    });
    Logger.error(err);
    throw err;
  }
...
test(`Test verificar cambio icono descuento total`, async ({ cursos }) => {
  try {
    ...
    await cursos.screenshot({
      path: screenshotPath(`Test verificar cambio icono descuento total`),
    });
    Logger.error(err);
    throw err;
  }
...
test(`Test verificar cambio icono descuento - listas`, async ({ listas }) => {
  try {
    ...
    await listas.screenshot({
      path: screenshotPath(`Test verificar cambio icono descuento - listas`),
    });
    Logger.error(err);
    throw err;
  }
...
test(`Test verificar cambio icono descuento total - listas`, async ({
  ...
  try {
    ...
    await listas.screenshot({
      path: screenshotPath(
        `Test verificar cambio icono descuento total - listas`
      ),
    });
    Logger.error(err);
    throw err;
...
test(`Test verificar cambio icono descuento diferente`, async ({ cursos }) => {
  try {
    ...
    await cursos.screenshot({
      path: screenshotPath(`Test verificar cambio icono descuento diferente`),
    });
    Logger.error(err);
    throw err;
  }
...
test(`Test verificar cambio icono descuento diferente - listas`, async ({
  ...
  try {
    ...
    await listas.screenshot({
      path: screenshotPath(
        `Test verificar cambio icono descuento diferente - listas`
      ),
    });
    Logger.error(err);
    throw err;
...
test(`Test verificar curso inscrito en horario`, async ({ cursos }) => {
  try {
    ...
    await cursos.screenshot({
      path: screenshotPath(`Test verificar curso inscrito en horario`),
    });
    Logger.error(err);
    throw err;
  }
...
test(`Test verificar eliminar curso inscrito en horario`, async ({
  ...
  try {
    ...
    await cursos.screenshot({
      path: screenshotPath(`Test verificar eliminar curso inscrito en horario`),
    });
    Logger.error(err);
    throw err;
  }
...
test(`Test verificar curso inscrito en horario - listas`, async ({
  ...
  try {
    ...
    await listas.screenshot({
      path: screenshotPath(`Test verificar curso inscrito en horario - listas`),
    });
    Logger.error(err);
    throw err;
  }
...
test(`Test verificar eliminar curso inscrito en horario - listas`, async ({
  ...
  try {
    ...
    await listas.screenshot({
      path: screenshotPath(
        `Test verificar eliminar curso inscrito en horario - listas`
      ),
    });
    Logger.error(err);
    throw err;
...
test(`Test verificar registro sin cursos inscritos`, async ({ cursos }) => {
  try {
    ...
    await cursos.screenshot({
      path: screenshotPath(`Test verificar registro sin cursos inscritos`),
    });
    Logger.error(err);
    throw err;
  }
...
test(`Test verificar registro sin cursos inscritos - listas`, async ({
  ...
  try {
    ...
    await listas.screenshot({
      path: screenshotPath(
        `Test verificar registro sin cursos inscritos - listas`
      ),
    });
    Logger.error(err);
    throw err;
...
test(`Test verificar registro virtual completado`, async ({ cursos }) => {
  try {
    ...
    await cursos.screenshot({
      path: screenshotPath(`Test verificar registro virtual completado`),
    });
    Logger.error(err);
    throw err;
  }
...
test(`Test verificar registro virtual completado - listas`, async ({
  ...
  try {
    ...
    await listas.screenshot({
      path: screenshotPath(
        `Test verificar registro virtual completado - listas`
      ),
    });
    Logger.error(err);
    throw err;
...
test(`Test verificar registro curso sin tutor seleccionado - listas`, async ({
  ...
  try {
    Logger.info(
      `Test verificar registro curso sin tutor seleccionado - listas`
    );
  ...
  for (const { key } of testCases) {
    test(`Test registro de nuevo curso inscrito: ${registroCursosInscritos[key].descripcion}`, async ({
      ...
      try {
        ...
        await cursos.screenshot({
          path: screenshotPath(
            `Test registro de nuevo curso inscrito: ${registroCursosInscritos[key].descripcion}`
          ),
        });
        Logger.error(err);
        throw err;
  ...
  for (const { key } of testCases) {
    test(`Test registro de pago nuevo curso inscrito: ${pagoCursosInscritos[key].descripcion}`, async ({
      ...
      try {
        ...
        await cursos.screenshot({
          path: screenshotPath(
            `Test registro de pago nuevo curso inscrito: ${pagoCursosInscritos[key].descripcion}`
          ),
        });
        Logger.error(err);
        throw err;
  ...
  for (const { key } of testCases) {
    test(`Test registro de nuevo curso inscrito lista: ${registroCursosInscritos[key].descripcion}`, async ({
      ...
      try {
        ...
        await listas.screenshot({
          path: screenshotPath(
            `Test registro de nuevo curso inscrito lista: ${registroCursosInscritos[key].descripcion}`
          ),
        });
        Logger.error(err);
        throw err;
  ...
  for (const { key } of testCases) {
    test(`Test registro de pago nuevo curso inscrito lista : ${pagoCursosInscritos[key].descripcion}`, async ({
      ...
      try {
        ...
        await listas.screenshot({
          path: screenshotPath(
            `Test registro de pago nuevo curso inscrito lista : ${pagoCursosInscritos[key].descripcion}`
          ),
        });
        Logger.error(err);
        throw err;
